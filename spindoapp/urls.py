...
from .views import CustomerIssueView, CustomerRegistrationView,CustomTokenRefreshView, LoginView, StaffAdminRegistrationView, VendorRegistrationView, ServiceCategoryView, VendorRequestView
urlpatterns = [
